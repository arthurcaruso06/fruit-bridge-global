  ...
  (exports.modules = {
      ...
      (() => {
        ...
        ((() => {
          ...
          function a(e, t, r) {
            ...
            if (void 0 === s || s) (a || (d += p + "?"), (d += r.endsWith ? "(?=" + f + ")" : "$"));
            else {
              var v = e[e.length - 1],
    ...
    8077: (e, t, r) => {
      ...
      function f(e) {
        ...
        let r = "";
        return (
          t.split("/").some((e) => (0, l.isGroupSegment)(e) || (0, l.isParallelRouteSegment)(e)) &&
      ...
      function d(e) {
        ...
        let t = e,
          r = "";
        if (
          ("/robots" === e ? (t += ".txt") : "/manifest" === e ? (t += ".webmanifest") : (r = f(e)),
          !t.endsWith("/route"))
        ) {
    ...
    9177: (e, t, r) => {
      ...
      let n = r(8977),
        ...
        o = ["js", "jsx", "ts", "tsx"],
        a = (e, t) =>
          t ? `(?:\\.(${e.join("|")})|((\\[\\])?\\.(${t.join("|")})))` : `\\.(?:${e.join("|")})`;
      function u(e, t, r) {
        let o = [
            RegExp(`^[\\\\/]robots${r ? `${a(t.concat("txt"), null)}$` : ""}`),
            RegExp(`^[\\\\/]manifest${r ? `${a(t.concat("webmanifest", "json"), null)}$` : ""}`),
            RegExp("^[\\\\/]favicon\\.ico$"),
            RegExp(`[\\\\/]sitemap${r ? `${a(["xml"], t)}$` : ""}`),
            RegExp(`[\\\\/]${i.icon.filename}\\d?${r ? `${a(i.icon.extensions, t)}$` : ""}`),
            RegExp(`[\\\\/]${i.apple.filename}\\d?${r ? `${a(i.apple.extensions, t)}$` : ""}`),
            RegExp(
              `[\\\\/]${i.openGraph.filename}\\d?${r ? `${a(i.openGraph.extensions, t)}$` : ""}`,
            ),
            RegExp(`[\\\\/]${i.twitter.filename}\\d?${r ? `${a(i.twitter.extensions, t)}$` : ""}`),
          ],
    ...
    8654: (e, t, r) => {
      ...
      function p(e, t, r, i, o) {
        if (i && t && o) {
          ...
          for (let e of (delete t.search, Object.keys(t.query))) {
            ...
            (n || i || (r || Object.keys(o.groups)).includes(e)) && delete t.query[e];
          }
          e.url = (0, n.format)(t);
        }
      }
          ...
          ? {
              params: (e = Object.keys(r.groups).reduce((o, a) => {
                ...
                ("string" == typeof u && (u = (0, l.normalizeRscURL)(u)),
                  Array.isArray(u) &&
                    (u = u.map(
                      (e) => ("string" == typeof e && (e = (0, l.normalizeRscURL)(e)), e),
                    )));
                let s = n[a],
                  ...
                  c &&
                    (!u ||
                      (Array.isArray(u) &&
                        ...
                        ("index" === u[0] || u[0] === `[[...${a}]]`))) &&
                    ((u = void 0), delete e[a]),
                  u && "string" == typeof u && r.groups[a].repeat && (u = u.split("/")),
                  u && (o[a] = u),
                  o
                );
              }, {})),
      ...
      function g({
        ...
        let y, E, v;
        return (
          l && ((y = (0, a.getNamedRouteRegex)(e, !1)), (v = (E = (0, u.getRouteMatcher)(y))(e))),
          {
                ...
                d = (n) => {
                  ...
                  if (c) {
                    ...
                    if (
                      ...
                      ((p = e.pathname),
                        (u.query.nextInternalLocale = e.detectedLocale || c.nextInternalLocale));
                    }
                    if (p === e) return !0;
                    if (l && E) {
                      let e = E(p);
              ...
              if (p !== e) {
                ...
                if (
                  ...
                  !(() => {
                    ...
                    return t === (0, c.removeTrailingSlash)(e) || (null == E ? void 0 : E(t));
                  })()
                ) {
                      ...
                      exec: (o) => {
                        ...
                        for (let e of Object.keys(a)) {
                          ...
                          e !== f.NEXT_QUERY_PARAM_PREFIX &&
                            ...
                            ((a[e.substring(f.NEXT_QUERY_PARAM_PREFIX.length)] = t), delete a[e]);
                        }
                        let s = Object.keys(i || {}),
                          c = (e) => {
                            if (t) {
    ...
    1089: (e, t, r) => {
      ...
      function i(e, t, r) {
        ...
        if (f !== i.origin) throw Error("invariant: invalid relative URL, router received " + e);
        return {
          pathname: a,
    ...
    8469: (e, t, r) => {
      ...
      function p(e) {
        ...
        for (let t of Object.keys({ ...e.params, ...r }))
          s = t
            ? s.replace(RegExp(":" + (0, i.escapeStringRegexp)(t), "g"), "__ESC_COLON_" + t)
            : s;
