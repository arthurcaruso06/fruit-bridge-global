    ...
    134: (e) => {
      ...
      function u(e) {
        ...
        return (function (e) {
          ...
          path: p,
          ...(h && { sameSite: c.includes((t = (t = h).toLowerCase())) ? t : void 0 }),
          ...(g && { secure: !0 }),
          ...(_ && { priority: l.includes((r = (r = _).toLowerCase())) ? r : void 0 }),
          ...(m && { partitioned: !0 }),
        });
      }
      (((e, r) => {
...
${t}`
      ...
      function m(e, { workAsyncStorage: t, workUnitAsyncStorage: r }) {
        let u = async (u, f) => {
          ...
          let y = (null == v ? void 0 : v.href) ?? "",
            b = (null == f ? void 0 : null == (m = f.method) ? void 0 : m.toUpperCase()) || "GET",
            S = (null == f ? void 0 : null == (_ = f.next) ? void 0 : _.internal) === !0,
          ...
          let A = (0, a.getTracer)().trace(
            ...
            async () => {
              ...
              let C = O && "unstable-cache" !== O.type ? O.implicitTags : [],
                x = O && "unstable-cache" === O.type ? "force-no-store" : R.fetchCache,
                w = !!R.isUnstableNoStore,
                I = v("cache"),
                D = "";
              "string" == typeof I &&
                void 0 !== E &&
                (("force-cache" === I && 0 === E) || ("no-store" === I && (E > 0 || !1 === E))) &&
              ...
              ("force-cache" === I && void 0 === E
                ? (E = !1)
                : (null == O ? void 0 : O.type) !== "cache" && (M || L) && (E = 0),
                ("no-cache" === I || "no-store" === I) && (D = `cache: ${I}`),
                (m = p(E, R.route)));
              let j = v("headers"),
                k = "function" == typeof (null == j ? void 0 : j.get) ? j : new Headers(j || {}),
                G = k.get("authorization") || k.get("cookie"),
                B = !["get", "head"].includes(
                  (null == (t = v("method")) ? void 0 : t.toLowerCase()) || "get",
                ),
                U = void 0 == x && (void 0 == I || "default" === I) && void 0 == E,
                H = (U && !R.isPrerendering) || ((G || B) && N && 0 === N.revalidate);
              ...
              if (
                  ...
                  ? "default-cache" !== x || w
                    ? "default-no-store" === x
                      ...
                      : w
                        ...
                        : H
                          ? ((m = 0), (D = "auto no cache"))
                          : ((D = "auto cache"), (m = N ? N.revalidate : o.INFINITE_CACHE))
                    : ((m = o.INFINITE_CACHE), (D = "fetchCache = default-cache"))
                  : D || (D = `revalidate: ${m}`),
                ...
                if (0 === m) {
                  ...
                  (0, i.markCurrentScopeAsDynamic)(R, O, `revalidate: 0 fetch ${u} ${R.route}`);
                }
              ...
              let X = () => Promise.resolve(),
                K = async (t, a) => {
                  ...
                  let s = {
                    ...f,
                    next: { ...(null == f ? void 0 : f.next), fetchType: "origin", fetchIdx: q },
                  };
                  return e(u, s)
                    .then(async (e) => {
                      if (
                        ...
                        if (O && "prerender" === O.type) {
                          ...
                          return (
                            await V.set(
                              ...
                              { fetchCache: !0, revalidate: r, fetchUrl: y, fetchIdx: q, tags: A },
                            ),
                            await X(),
                            new Response(a, {
                              headers: e.headers,
                              ...
                              .then(async (e) => {
                                ...
                                (null == $ ||
                                  ...
                                  F &&
                                    (await V.set(
                                      n,
                                      { kind: c.CachedRouteKind.FETCH, data: s, revalidate: t },
                                      {
                                        fetchCache: !0,
                                        revalidate: r,
                                        fetchUrl: y,
              ...
              if (n && V) {
                ...
                if (
                  ...
                  if (
                    ...
                    t ? await X() : (a = "cache-control: no-cache (hard refresh)"),
              ...
              if (R.isStaticGeneration && f && "object" == typeof f) {
                ...
                if ("no-store" === e) {
                  ...
                  (0, i.markCurrentScopeAsDynamic)(R, O, `no-store fetch ${u} ${R.route}`);
                }
                let t = "next" in f,
                  { next: r = {} } = f;
                if ("number" == typeof r.revalidate && N && r.revalidate < N.revalidate) {
                  ...
                  (R.forceStatic && 0 === r.revalidate) || (N.revalidate = r.revalidate);
                }
                t && delete f.next;
              }
              if (!n || !W) return K(!1, a);
      ...
      class b {
        ...
        trace(...e) {
          ...
          let p = this.getSpanContext(
            ...
            _ = !1;
          p
            ? (null == (t = u.getSpanContext(p)) ? void 0 : t.isRemote) && (_ = !0)
      ...
      class s {
        ...
        async get(e, t, r) {
          ...
          let {
            ...
            c = await this.batcher.batch({ key: e, isOnDemandRevalidate: o }, async (c, l) => {
              var d, f;
              if (
                this.minimalMode &&
                (null == (d = this.previousCacheItem) ? void 0 : d.key) === c &&
              ...
              try {
                if (
                  ...
                  if (
                    (l({ ...g, revalidate: g.curRevalidate }), (h = !0), !g.isStale || r.isPrefetch)
                  )
                    return null;
                }
                let d = await t({ hasResolved: h, previousCacheEntry: g, isRevalidating: !0 });
                if (!d) return (this.minimalMode && (this.previousCacheItem = void 0), null);
                let m = await (0, i.fromResponseCacheEntry)({ ...d, isMiss: !g });
                if (!m) return (this.minimalMode && (this.previousCacheItem = void 0), null);
                return (
                  o || h || (l(m), (h = !0)),
                  void 0 !== m.revalidate &&
                    (this.minimalMode
                      ? (this.previousCacheItem = { key: c, entry: m, expiresAt: Date.now() + 1e3 })
                ...
                if (
                  (g &&
                    (await a.set(e, g.value, {
                      revalidate: Math.min(Math.max(g.revalidate || 3, 3), 30),
                      isRoutePPREnabled: u,
                      isFallback: s,
                    })),
                  h)
    ...
    7212: (e, t, r) => {
      ...
      async function O(e, { inlinedDataStream: t, getServerInsertedHTML: r }) {
        return e.pipeThrough(m()).pipeThrough(v(r)).pipeThrough(y(t)).pipeThrough(S());
      }
    ...
    1639: (e, t, r) => {
      ...
      class u extends Request {
        constructor(e, t = {}) {
          ...
          ((0, a.validateURL)(r), e instanceof Request ? super(e, t) : super(r, t));
    ...
    4171: (e, t, r) => {
      ...
      function i(e, t) {
        ...
        s &&
          ...
          ((l.pathname = (0, a.removePathPrefix)(l.pathname, s)), (l.basePath = s));
        let d = l.pathname;
