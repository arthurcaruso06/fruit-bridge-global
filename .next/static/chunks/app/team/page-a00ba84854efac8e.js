(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  ...
  {
    2893: (t, e, a) => {
      Promise.resolve().then(a.bind(a, 5643));
    },
    5643: (t, e, a) => {
      "use strict";
            ...
            (0, i.jsxs)("div", {
              ...
              children: [
                ...
                (0, i.jsx)(l.P.h1, {
                  ...
                  children: t.teamPage.title,
                }),
                (0, i.jsx)(l.P.p, {
                  ...r,
                  transition: { ...r.transition, delay: 0.2 },
                  className: "text-lg text-muted-foreground leading-relaxed font-light max-w-2xl",
                  children: t.teamPage.intro,
                }),
              ],
            }),
            (0, i.jsx)("div", {
              className: "mx-auto max-w-6xl px-6 lg:px-12 space-y-0",
              children: t.teamPage.sections.map((t, e) => {
                let a = e % 2 == 0;
                return (0, i.jsxs)(
                  l.P.div,
                  {
                    ...r,
                    transition: { ...r.transition, delay: 0.1 * e },
                    className:
                      "flex flex-col lg:flex-row items-stretch border-b border-border ".concat(
                        a ? "" : "lg:flex-row-reverse",
                      ),
                    children: [
                      (0, i.jsx)("div", {
                        className:
  ...
  (t) => {
    var e = (e) => t((t.s = e));
    (t.O(0, [110, 656, 441, 517, 358], () => e(2893)), (_N_E = t.O()));
  },
]);
