...
interface TeamSection { title: string; text: string; }
interface Contact { name: string; email: string; phone: string; }

export interface TranslationSet {
  nav: { home: string; history: string; team: string; products: string; sas: string; contact: string };
  hero: { title: string; subtitle: string; experience: string; international: string; quality: string; cta1: string; cta2: string };
  ...
  contactPage: { title: string; phone: string; address: string; contactsTitle: string; contacts: Contact[] };
  footer: { rights: string; tagline: string };
}

const contacts: Contact[] = [
  { name: 'André Schenk', email: 'andre@vivafruta.com.br', phone: '+55 11 98178-4445' },
  { name: 'Rosana Melo', email: 'rosana@vivafruta.com.br', phone: '+55 11 99403-5089' },
  { name: 'Eduardo Tomazian', email: 'eduardo@vivafruta.com.br', phone: '+55 11 94242-4445' },
  { name: 'Marcio Nascimento', email: 'marcio@vivafruta.com.br', phone: '+55 11 97278-4445' },
  ...
  { name: 'Letícia Piassi', email: 'leticia@vivafruta.com.br', phone: '+55 11 97470-4445' },
  { name: 'Roberta Leme', email: 'roberta@vivafruta.com.br', phone: '+55 11 98444-9729' },
  { name: 'Jefferson Ramos', email: 'jefferson@vivafruta.com.br', phone: '+55 11 91663-4445' },
];

const partners = {
  main: ['Paramount', 'Novafruit', 'Blue Whale'],
  all: ['Agroland', 'Chilfresh', 'Especial Frutas', 'Exportadora Lecaros', 'Exportadora Propal SA', 'Frueat by Moudiris', 'Fruilomar', 'Fruits De Ponent', 'Frutaria', 'Los Lirios', 'Luis Vicente', 'Nogal', 'Paloma', 'Roberto Salerno SA', 'Shanghai', 'Spreafico - CL'],
};
...
const pt: TranslationSet = {
  ...
  teamPage: {
    title: 'Nosso Time',
    intro: 'Na Viva, nossa força está no time que faz acontecer. Somos especialistas em conectar produtos frescos a quem precisa, com uma atuação comercial ágil e estratégica',
    sections: [
      { title: 'Time de Qualidade', text: 'Nossa equipe realiza uma inspeção rigorosa na chegada das frutas, assegurando que cada lote esteja em perfeito estado, cumprindo todos os requisitos de frescor, segurança e qualidade exigidos pelo mercado.' },
      { title: 'Time Comercial', text: 'Profissionais que conhecem o mercado, entendem as necessidades dos clientes e atuam com agilidade para oferecer as melhores soluções, fortalecendo parcerias e abrindo portas.' },
      { title: 'Time Financeiro', text: 'Organizado, transparente e eficiente, nosso financeiro facilita as negociações, garantindo segurança e flexibilidade para todas as partes envolvidas.' },
      { title: 'Time Operacional', text: 'Responsável pela análise e gestão completa dos documentos, além do acompanhamento rigoroso dos embarques, garantindo que toda a logística ocorra dentro do prazo e com máxima eficiência.' },
    ],
  },
  sasPage: {
    title: 'SAS',
  ...
  contactPage: {
    ...
    address: 'Av. José Cesar de Oliveira, 181 – Conj. 506/507\nCEP: 05317-000, São Paulo/SP - Brasil',
    contactsTitle: 'Contatos',
    contacts,
  },
  footer: { rights: 'Todos os direitos reservados.', tagline: 'Trading internacional de frutas frescas' },
};
...
const en: TranslationSet = {
  ...
  teamPage: {
    title: 'Our Team',
    intro: 'At Viva, our strength lies in the team that makes it happen. We are specialists in connecting fresh products to those who need them, with agile and strategic commercial operations',
    sections: [
      { title: 'Quality Team', text: 'Our team performs rigorous inspection upon fruit arrival, ensuring that each lot is in perfect condition, meeting all freshness, safety and quality requirements demanded by the market.' },
      { title: 'Commercial Team', text: 'Professionals who know the market, understand client needs and act with agility to offer the best solutions, strengthening partnerships and opening doors.' },
      { title: 'Financial Team', text: 'Organized, transparent and efficient, our financial team facilitates negotiations, ensuring security and flexibility for all parties involved.' },
      { title: 'Operations Team', text: 'Responsible for the complete analysis and management of documents, as well as rigorous shipment monitoring, ensuring that all logistics occur on time and with maximum efficiency.' },
    ],
  },
  sasPage: {
    title: 'SAS',
  ...
  contactPage: {
    title: 'Contact',
    phone: '+55 11 3641-2744',
    address: 'Av. José Cesar de Oliveira, 181 – Suite 506/507\nZIP: 05317-000, São Paulo/SP - Brazil',
...
const es: TranslationSet = {
  ...
  teamPage: {
    ...
    intro: 'En Viva, nuestra fuerza está en el equipo que hace que las cosas sucedan. Somos especialistas en conectar productos frescos a quien los necesita, con una actuación comercial ágil y estratégica',
    sections: [
      { title: 'Equipo de Calidad', text: 'Nuestro equipo realiza una inspección rigurosa en la llegada de las frutas, asegurando que cada lote esté en perfecto estado, cumpliendo todos los requisitos de frescura, seguridad y calidad exigidos por el mercado.' },
      { title: 'Equipo Comercial', text: 'Profesionales que conocen el mercado, entienden las necesidades de los clientes y actúan con agilidad para ofrecer las mejores soluciones, fortaleciendo alianzas y abriendo puertas.' },
      { title: 'Equipo Financiero', text: 'Organizado, transparente y eficiente, nuestro financiero facilita las negociaciones, garantizando seguridad y flexibilidad para todas las partes involucradas.' },
      { title: 'Equipo Operacional', text: 'Responsable del análisis y gestión completa de los documentos, además del seguimiento riguroso de los embarques, garantizando que toda la logística ocurra dentro del plazo y con máxima eficiencia.' },
    ],
  },
  sasPage: {
    title: 'SAS',
  ...
  footer: { rights: 'Todos los derechos reservados.', tagline: 'Trading internacional de frutas frescas' },
};
